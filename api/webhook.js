...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Note: Webhook URL is now embedded in the Lua script
        // The Lua script will send data to this endpoint which will forward to the embedded webhook
        ...
        // Note: In this version, the webhook URL is embedded in the Lua script
        // The Lua script should handle sending data directly to Discord
        // This endpoint acts as a proxy/forwarder
